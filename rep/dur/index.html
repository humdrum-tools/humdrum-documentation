...
description: |
    Documentation for the \*\*dur Humdrum representaton; software for music
    research.
keywords: |
    music research,duration,software,theory,analysis,systematic
    musicology,computer representation,\*\*dur
revision-date: 'Thu Feb 3 10:31:10 EST 2000'
robots: all
title: 'Humdrum Toolkit Representation Reference - Duration'
---
