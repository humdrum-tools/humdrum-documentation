...
description: |
    Documentation for the \*\*solfg Humdrum representaton; software for
    music research.
keywords: |
    music research,solfege,software,theory,analysis,systematic
    musicology,computer representation,\*\*solfg
revision-date: 'Thu Feb 3 10:31:10 EST 2000'
robots: all
title: 'Humdrum Toolkit Representation Reference - French Solfège'
---
...
-   [**Pertinent description in the Humdrum User
    Guide**](../guide04.html#French_Solfège)
