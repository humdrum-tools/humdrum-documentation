...
description: |
    Documentation for the \*\*melac Humdrum representaton; software for
    music research.
keywords: |
    music research,melodic accent,software,theory,analysis,systematic
    musicology,computer representation,\*\*melac
revision-date: 'Thu Feb 3 10:31:10 EST 2000'
robots: all
title: 'Humdrum Toolkit Representation Reference - Melodic Accent'
---
