...
description: |
    Documentation for the \*\*pitch Humdrum representaton; software for
    music research.
keywords: |
    music research,pitch,software,theory,analysis,systematic
    musicology,computer representation,\*\*pitch
revision-date: 'Thu Feb 3 10:31:10 EST 2000'
robots: all
title: 'Humdrum Toolkit Representation Reference - Pitch'
---
