...
<span class="rep">harm</span> &mdash; representation for Western functional harmony
...
are normally identified within a key context &mdash; such as G minor, or
...
*VI* chords are ambiguous &mdash; they simply denote mediant and
...
root may be achieved by adding a flat or by adding a natural &mdash;
...
letter \`o\' &mdash; for example, the diminished triad with a root on the
leading tone is denoted as \"viio.\" Augmented chords are indicated by
the explicit addition of the plus sign (+) &mdash; e.g. \"III+\" for the
...
Seventh chords are indicated by the addition of the number \"7\" &mdash;
...
whether the interval is major or minor &mdash; signified by use of the
...
an \"X of Y\" approach &mdash; e.g. V of V. In the <span class="rep">harm</span>
...
&mdash; e.g. V7/IV, I/IV, vi/IV, ii/IV, V/II/IV, II/IV, etc. (Notice the
...
&mdash; such as the Neopolitan chord, and the \"ethnic sixth\" chords:
...
encoded by specifying a set of intervals above the bass pitch &mdash; with
