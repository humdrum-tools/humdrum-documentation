...
description: |
    Documentation for the \*\*harm Humdrum representaton; software for music
    research.
keywords: |
    music research,functional harmony,software,theory,analysis,systematic
    musicology,computer representation,\*\*harm
revision-date: 'Thu Feb 3 10:31:10 EST 2000'
robots: all
title: 'Humdrum Toolkit Representation Reference - Functional Harmony'
---
