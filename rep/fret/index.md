...
<span class="rep">fret</span> &mdash; generalized fretted tablature representation
...
distinguishing different visual renderings &mdash; such as traditional
...
&mdash; except that two strings sound together, rather than a single
string.
...
&mdash; where each course is delineated by a colon (:). In the following
...
most common relative tuning for the six-string guitar &mdash; where
...
Historically, the 6-course *lute* was tuned in a variety of ways &mdash;
...
the *default fret tuning* &mdash; which is an increase of precisely one&mdash;
...
instruments this means strumming \"downward\" &mdash; from the lowest- to
...
used to signify the so-called *rasgeado* &mdash; or flamboyant Spanish
strum. Once again these signifiers appear at the beginning of a
tablature-token &mdash; whenever they are encoded. Strumming all 6 open
