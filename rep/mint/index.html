...
description: |
    Documentation for the \*\*mint Humdrum representaton; software for music
    research.
keywords: |
    music research,melodic intervals,software,theory,analysis,systematic
    musicology,computer representation,\*\*mint
revision-date: 'Thu Feb 3 10:31:10 EST 2000'
robots: all
title: 'Humdrum Toolkit Representation Reference - Melodic Interval'
---
