...
description: |
    Documentation for the \*\*text Humdrum representaton; software for music
    research.
keywords: |
    music research,vocal text,lyrics,software,theory,analysis,systematic
    musicology,computer representation,\*\*text
revision-date: 'Thu Feb 3 10:31:10 EST 2000'
robots: all
title: 'Humdrum Toolkit Representation Reference - Vocal Text'
---
