...
description: |
    Documentation for the \*\*time Humdrum representaton; software for music
    research.
keywords: |
    music research,elapsed time,software,theory,analysis,systematic
    musicology,computer representation,\*\*time
revision-date: 'Thu Feb 3 10:31:10 EST 2000'
robots: all
title: 'Humdrum Toolkit Representation Reference - Elapsed Time'
---
