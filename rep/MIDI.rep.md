...
description: |
    Documentation for the \*\*MIDI Humdrum representaton; software for music
    research.
keywords: |
...
robots: all
title: 'Humdrum Toolkit Representation Reference - MIDI'
---
...
-   [**Pertinent description in the Humdrum User
    Guide**](../guide07.html#The_**MIDI_Representation)
