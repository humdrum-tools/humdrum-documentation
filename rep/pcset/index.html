...
description: |
    Documentation for the \*\*pcset Humdrum representaton; software for
    music research.
keywords: |
    music research,pitch-class sets,software,theory,analysis,systematic
    musicology,computer representation,\*\*pcset
revision-date: 'Thu Feb 3 10:31:10 EST 2000'
robots: all
title: 'Humdrum Toolkit Representation Reference - Pitch-Class Sets'
---
