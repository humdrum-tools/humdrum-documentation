...
description: |
    Documentation for the \*\*date Humdrum representaton; software for music
    research.
keywords: |
    music research,absolute time,software,theory,analysis,systematic
    musicology,computer representation,\*\*date
revision-date: 'Thu Feb 3 10:31:10 EST 2000'
robots: all
title: 'Humdrum Toolkit Representation Reference - Absolute Time'
---
...
> 1921. The \`x\' may precede or follow a given value \-- provided it is
...
> follow a given value \-- provided it is adjacent to the uncertain
> value.
>
