...
description: |
    Documentation for the \*\*spect Humdrum representaton; software for
    music research.
keywords: |
    music research,frequency,spectra,software,theory,analysis,systematic
    musicology,computer representation,\*\*spect
revision-date: 'Thu Feb 3 10:31:10 EST 2000'
robots: all
title: 'Humdrum Toolkit Representation Reference - Frequency Spectra'
---
