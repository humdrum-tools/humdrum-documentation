...
**cleave** &mdash; join tokens from two or more Humdrum spines into a single
output spine
...
`**kern` data &mdash; and will output the amalgamated data in a spine
labelled `**output`.
...
> > line &mdash; i.e., `**diaton` values first, followed by `**accid`,
