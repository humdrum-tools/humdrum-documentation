...
in the input. With the **-a** option, <span class="tool">num</span> creates a new spine which
...
The **-e** option causes numbers generated by <span class="tool">num</span> to be append to
...
The **-n** option causes <span class="tool">num</span> to output numerical values, only when
