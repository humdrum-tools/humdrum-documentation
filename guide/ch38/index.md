...
<span class="tool">scramble</span> is invoked, it produces a
...
<span class="tool">scramble</span> command, and then use
<span class="tool">patt</span> to count the number of occurrences in the
