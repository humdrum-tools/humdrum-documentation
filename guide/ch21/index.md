...
The operation of <span class="tool">patt</span> is easier to describe
...
In order to search for such picardy thirds, we should translate
...
When the <span class="option">t</span> option is invoked, <span
