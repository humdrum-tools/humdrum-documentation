...
passing an input through the <span class="tool">spect</span> command.
...
If more than one instrument is playing concurrently, then <span class="tool">spect</span> will
