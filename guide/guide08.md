...
description: |
    Chapter 8 (The Shell) of the User Guide for the Humdrum Toolkit music
    research software.
keywords: |
...
robots: all
title: 'Humdrum Toolkit User\''s Guide \-- Chapter 8'
---

  -------------------------------- ----------------------------------------- ----------------------------------------
  ![ ](/Humdrum/HumdrumIcon.gif)    ![Humdrum ](/Humdrum/HumdrumHeader.gif)    ![ ](/Humdru/HumdrumHumdrumSpacer.gif)
  -------------------------------- ----------------------------------------- ----------------------------------------
